          ...
          <Box sx={styles.banner.col}>
            <Box sx={styles.banner.content}>
              <Box sx={styles.banner.stars}>
                ...
                <FaStar />
                <FaStar />
                Tin tưởng bởi 6,332 học sinh trên toàn quốc
              </Box>
              <Heading as="h3">
                Luyện thi Cambridge <br />
                cùng mentor giỏi
              </Heading>
              <Text as="p">
                Tutor+ tự hào là một trung tâm hàng đầu hỗ trợ học sinh <br />
                những thông tin, kiến thức và kinh nghiệm để giúp các em đạt điểm cao<br />
                trong các kì thi quốc tế như IB, Cambridge, SAT, IELTS
              </Text>
            </Box>
          </Box>
          <Box sx={styles.banner.col}>
